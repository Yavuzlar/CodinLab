...
func (m *RoadDTOManager) ToRoadDTO(road domains.Road, paths []PathDTO, isImageExists bool, inventoryLanguage domains.InventoryLanguage, fileExtension, monacoEditor string) RoadDTO {
	return RoadDTO{
